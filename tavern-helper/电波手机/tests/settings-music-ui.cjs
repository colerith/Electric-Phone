...
const appearance = fs.readFileSync(path.join(root, 'components/settings/WaveHomeAppearance.vue'), 'utf8');
const music = fs.readFileSync(path.join(root, 'components/music/WaveMusicPanel.vue'), 'utf8');
const playlists = fs.readFileSync(path.join(root, 'components/music/WavePlaylists.vue'), 'utf8');
const musicStore = fs.readFileSync(path.join(root, 'stores/music.ts'), 'utf8');
const settingsStyle = fs.readFileSync(path.join(root, 'styles/settings/settings.scss'), 'utf8');
const musicStyle = fs.readFileSync(path.join(root, 'styles/apps/music-refinements.scss'), 'utf8');
