<template>
  <section class="wave-app-content app-function-settings wave-settings-surface">
    ...
    <section v-if="app === 'zone' || app === 'wallet'" class="chat-settings-group system-settings-card">
    ...
    <p v-if="app === 'zone'" class="function-settings-footnote">
      社交昵称、头衔和签名随角色的故事更新。自选封面独立保存。
    </p>
    <p v-if="app === 'wallet'" class="function-settings-footnote">卡面仅改变外观，账目与收支记录会保留。</p>
...
import { isLimitedApp } from '../services/module-updates';
import WaveChatCleanup from './WaveChatCleanup.vue';
import WaveChatPreferences from './WaveChatPreferences.vue';

import { ref } from 'vue';
import { musicProviders } from '../services/music';
import { usePhoneStore } from '../stores/phone';
import WaveCharacterVoice from './WaveCharacterVoice.vue';
const phone = usePhoneStore();
import WaveSelect from './WaveSelect.vue';
import WaveToggle from './WaveToggle.vue';
import type { SearchEngine } from '../services/browser';
import WaveImageUpload from './WaveImageUpload.vue';
import WaveWeatherLocation from './WaveWeatherLocation.vue';
import type { WeatherLocation } from '../services/weather';
import { zoneArtworks, walletArtworks, artworkUrl } from '../services/artworks';
defineProps<{
  app: string;
  name: string;
  artwork: string;
